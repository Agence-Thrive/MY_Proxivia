...
export default {
    ...
    mounted() {
        ...
        axios
            .get(
                `${process.env.VUE_APP_ROOT_API}/api/v1/users/${this.info._id}/prospect/lost`,
                {
                    headers: {
            ...
            .then(function(response) {
                for (const prospect in response.data) {
                    axios
                        .get(
                            `${process.env.VUE_APP_ROOT_API}/api/v1/users/${this.user}/prospect/${this.info.prospects[prospect]}`,
                            {
                                headers: {
                                    Authorization: `Bearer ${this.token}`,
                                },
